...
def user_input_features():
    ...
    numerical_data = {
        "Temperature": st.sidebar.slider("Temperature (°C)", -30.0, 130.0, 20.0),
        "Humidity": st.sidebar.slider("Humidity (%)", 10, 120, 50),
        "Wind Speed": st.sidebar.slider("Wind Speed (km/h)", 0.0, 70.0, 10.0),
        "Precipitation": st.sidebar.slider("Precipitation (%)", 0.0, 120.0, 10.0),
        "Atmospheric Pressure": st.sidebar.slider("Atmospheric Pressure (hPa)", 700.0, 1300.0, 1000.0),
        "UV Index": st.sidebar.slider("UV Index", 0.0, 20.0, 10.0),
        "Visibility (km)": st.sidebar.slider("Visibility (km)", 0.0, 30.0, 10.0),
    }
